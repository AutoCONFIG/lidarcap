...
def get_cfg_defaults():
    ...
    cfg.TrainDataset.replace_noice_pc = False
    cfg.TrainDataset.replace_noice_pc_rate = False
    cfg.TrainDataset.replace_pc_strategy = 'random'
    cfg.TrainDataset.noise_distribution = 'uniform'
    cfg.TrainDataset.add_noice_pc = False
    ...
    cfg.TestDataset.replace_noice_pc = False
    cfg.TestDataset.replace_noice_pc_rate = False
    cfg.TestDataset.noise_distribution = 'uniform'
    cfg.TestDataset.add_noice_pc = False
